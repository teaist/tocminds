...
import { ɵɵdefineInjectable, Injectable, InjectionToken, inject, LOCALE_ID, EventEmitter, ElementRef, NgZone, ChangeDetectorRef, Optional, Inject, Input, Output, Component, ChangeDetectionStrategy, ViewChild, Directive, TemplateRef, Injector, SkipSelf, ViewContainerRef, forwardRef, Renderer2, Pipe, NgModule } from '@angular/core';
 ...
 */
let OwlDateTimeTriggerDirective = class OwlDateTimeTriggerDirective {
 ...
 * numberFixedLen.pipe
 */
let NumberFixedLenPipe = class NumberFixedLenPipe {
    transform(num, len) {
 ...
 * dialog.module
 */
let OwlDialogModule = class OwlDialogModule {
};
 ...
 * date-time.module
 */
let OwlDateTimeModule = class OwlDateTimeModule {
};
...
let OwlNativeDateTimeModule = class OwlNativeDateTimeModule {
};
...
let OwlMomentDateTimeModule = class OwlMomentDateTimeModule {
};
